...
public class EtchedMessages {
    ...
    public static final SimpleChannel PLAY = NetworkRegistry.newSimpleChannel(new Identifier(Etched.MOD_ID, "play"), () -> "3", "3"::equals, "3"::equals);
    ...
    private static <MSG extends EtchedPacket> void register(Class<MSG> clazz, Function<PacketByteBuf, MSG> decoder, @Nullable NetworkDirection direction) {
